...
@section('content')
    @php
        ...
        $canViewApplicantsList =
            $canViewApplications || $canEditApplications || $canDeleteApplications || $canViewHiring;
    @endphp

    <div class="p-6 mx-auto max-w-7xl">

        <x-page-header title="Applications" subtitle="Record walk-in or manual applicant entries for this branch." />
            ...
            <div class="p-6 mt-6 bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
                ...
                <form action="{{ route('hiring.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <h3
                                class="flex items-center gap-2 mb-4 text-xs font-bold tracking-widest text-[#8B7355] uppercase">
                                ...
                                <div>
                                    ...
                                    <select name="position_applied" required
                                        ...
                                        <option value="therapist"
                                            {{ old('position_applied') == 'therapist' ? 'selected' : '' }}>Therapist
                                        </option>
                                        <option value="receptionist"
                                            {{ old('position_applied') == 'receptionist' ? 'selected' : '' }}>Receptionist
                                        </option>
                                        <option value="manager"
                                            {{ old('position_applied') == 'manager' ? 'selected' : '' }}>Manager</option>
                                        <option value="hr" {{ old('position_applied') == 'hr' ? 'selected' : '' }}>HR
                                        </option>
                                ...
                                <div>
                                    ...
                                    <select name="availability"
                                        ...
                                        <option value="full_time"
                                            {{ old('availability') == 'full_time' ? 'selected' : '' }}>Full Time</option>
                                        <option value="part_time"
                                            {{ old('availability') == 'part_time' ? 'selected' : '' }}>Part Time</option>
                                ...
                                <div>
                                    ...
                                    <select name="education"
                                        ...
                                        <option value="high_school"
                                            {{ old('education') == 'high_school' ? 'selected' : '' }}>High School</option>
                                        <option value="vocational"
                                            {{ old('education') == 'vocational' ? 'selected' : '' }}>Vocational</option>
                                        <option value="undergraduate"
                                            {{ old('education') == 'undergraduate' ? 'selected' : '' }}>Undergraduate
                                        </option>
                            ...
                            <div class="flex flex-col p-4 border border-gray-100 applicant-card rounded-xl bg-gray-50 dark:bg-gray-900 dark:border-gray-700"
                                ...
                                <div class="flex items-start justify-between gap-2">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="flex items-center justify-center flex-shrink-0 w-10 h-10 rounded-full bg-[#8B7355] text-white font-semibold text-sm">
